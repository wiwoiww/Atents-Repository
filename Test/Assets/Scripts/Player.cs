...
public class Player : MonoBehaviour
{
    ...
    //Action de12;                          // 리턴타입이 void, 파라메터도 없는 델리게이트 de12를 만듬
    //Action<int> de13;                     // 리턴타입이 void, 파라메터는 int 하나인 델리게이트 de13을 만듬
    //Func<int, float> de14;                // 리턴타입이 int고 파라메터는 float 하나인 델리게이트 de14를 만듬 
