...
namespace _2일차복습
{
    ...
    public class Character   // Character 클래스를 public으로 선언한다.
    {
        ...
        //    // % : 앞에 숫자를 뒤의 숫자로 나눈 나머지값을 돌려주는 연산자. (묘듈레이트 연산. 나머지 연산)
        //    // 10 % 3 하면 결과는 1
        ...
        //배열 대괄호 안에들어간걸 "인덱스"라고함 항상 0부터 시작
        ...
        public int HP
        {
            get // 이 프로퍼티를 읽을 때 호출되는 부분
            {
                return hp;
            }

            set // 이 프로퍼티에 값을 넣을 때 호출되는 부분
            {
        ...
        public Character()
        {
            ...
            // 3. hp는 maxHP와 같은 값이다.
            // 4. strenth, dexterity, intellegence는 1~20 사이로 랜덤하게 정해진다.
