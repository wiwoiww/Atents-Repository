...
public class Background : MonoBehaviour
{
    ...
    protected virtual void Awake()
    {
        ...
        for (int i=0; i<transform.childCount; i++)  // 일반 for는 정확한 인덱스가 필요할 때 유리
        {
    ...
    private void Update()
    {
        ...
        //        slot.Translate(Background_Width * bgSlots.Length * transform.right);    // 오른쪽으로 Background_의 3배(bgSlots.Length에 3개가 들어있으니까) 만큼 이동
        //    }
        //}
